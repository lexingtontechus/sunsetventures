            ...
            <div className="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-xl rounded-lg mt-32 bg-gradient-to-l from-trueZinc-400 to-trueZinc-600">
              <div className="px-6">
                <div className="flex flex-wrap justify-center">
                  <div className="w-full lg:w-3/12 px-4 lg:order-2 flex justify-center">
                    <div className="relative -mt-32">
                      <Link
                        href="/"
                        className="inline-flex h-content border-trueZinc-900 dark:border-trueZinc-50 w-auto rounded-full h-auto align-middle border-2 max-w-150-px focus:bg-trueZinc-500"
                      >
                        <Brand />
                      </Link>
                    </div>
                  ...
                  <div className="w-full lg:w-4/12 px-4 lg:order-1">
                    <div className="flex justify-center py-4 lg:pt-4 pt-8">
                      <div className="mr-4 p-3 text-center">
                        <button
                          className="bg-trueZinc-900 text-trueZinc-50 w-10 h-10 rounded-full outline-none focus:outline-none mr-1 mb-1"
                          type="button"
                        >
                          <Link
                      ...
                      <div className="lg:mr-4 p-3 text-center">
                        {/*<span className=" text-xl font-bold block uppercase tracking-wide text-trueZinc-100 dark:text-trueZinc-100">*/}
                        <button
                          className="p-2 bg-trueZinc-900 text-trueZinc-50 w-10 h-10 rounded-full outline-none focus:outline-none mr-1 mb-1"
                          type="button"
                        >
                          <Link
                ...
                <div className="text-center mt-8">
                  <h3 className="inline-block text-3xl font-semibold leading-normal my-4 text-trueZinc-100 dark:text-trueZinc-100 fill-Zinc-800 dark:fill-yellow-300">
                    Sunset Ventures Inc.
                  </h3>
                  <p className="font-semibold text-trueZinc-100 dark:text-trueZinc-100 mb-4">
                    Investment Management.
                  </p>
                  <div className="text-sm leading-normal mt-0 my-4 text-trueZinc-100 dark:text-trueZinc-100 font-bold uppercase">
                    <FontAwesomeIcon
                      icon={faLocationDot} //"fa-solid fa-location-dot "
                      className="mr-2 text-lg text-trueZinc-100 dark:text-trueZinc-100"
                      aria-hidden="true"
                    />
                    Los Angeles, California
                  </div>
                  <div className="text-sm leading-normal mt-0 my-4 text-trueZinc-100 dark:text-trueZinc-100 font-bold lowercase">
                    <FontAwesomeIcon
                  ...
                  <div className="text-trueZinc-100 dark:text-trueZinc-100 mx-4">
                    <p className="italic mt-2 ">
                      Building the investment portfolios of our clients &
                      partners.
                    </p>
                  </div>
                </div>
                <div className="mt-8 py-10 border-t border-trueZinc-200 text-center">
                  <div className="flex flex-wrap justify-center">
                    <div className="w-full lg:w-9/12 px-4">
                      <h3 className="text-xl font-semibold leading-normal my-2 text-trueZinc-100 dark:text-trueZinc-100">
                        Creating innovative investment strategies & growing our
                        next-gen AI Quant platform.
                      </h3>
                      <h3 className="text-xl font-semibold leading-normal my-4 text-trueZinc-100 dark:text-trueZinc-100">
                        Our services span across,
                      </h3>
                      <div className="my-8 text-lg leading-relaxed text-trueZinc-100 dark:text-trueZinc-100">
                        <p className="my-4">
                          <FontAwesomeIcon
