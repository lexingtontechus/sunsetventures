...
export default function Cta() {
  return (
    <Container>
      <div className="flex flex-wrap items-center justify-between w-full mx-auto text-trueZinc-700 dark:text-trueZinc-100 bg-trueZinc-100 dark:bg-trueZinc-800 px-7 py-7 lg:px-12 lg:py-12 lg:flex-nowrap rounded-xl">
