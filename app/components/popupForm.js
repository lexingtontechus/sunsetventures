...
export default function PopupForm() {
  ...
  return (
    <div className="flex mx-auto h-full min-h-[250px] flex-col overflow-hidden rounded-md border border-secondary shadow-2xl sm:max-h-[calc(100vh-120px)] sm:w-[350px]">
      <div className="h-full flex-grow overflow-auto p-8">
        {!isSubmitSuccessful && (
          <form onSubmit={handleSubmit(onSubmit)} noValidate>
            ...
            <div className="p-0">
              ...
              <input
                ...
                className={`w-full rounded-md border border-accent bg-neutral px-3 py-2 placeholder-neutral focus:outline-none focus:ring   ${
                  errors.name
            ...
            <div className="mb-4">
              ...
              <textarea
                ...
                className={`h-28 w-full rounded-md border border-accent bg-neutral px-3 py-2 placeholder-neutral focus:outline-none focus:ring   ${
                  errors.message
                    ? "border-error ring-error focus:border-error"
                    : "border-accent ring-base-200 focus:border-base-200"
                }`}
            ...
            <div className="mb-3 inline-block w-full rounded-md py-2 text-center">
              <button
                type="submit"
                className="btn btn-accent my-2 rounded-md p-2 focus:outline-none"
              >
                {isSubmitting ? (
                  <svg
        ...
        {isSubmitSuccessful && !isSuccess && (
          <div className="flex h-full flex-col items-center justify-center rounded-md text-center">
            ...
            <button
              auto
              className="btn btn-accent glass mt-6 rounded-md p-2 focus:outline-none"
              onClick={() => reset()}
            >
              Go back
            </button>
