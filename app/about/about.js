      ...
      <div className="container mx-auto">
        ...
        <div className="text-center py-4">
          ...
          <div className="align-center my-4">
            <ul className="menu menu-horizontal rounded-box hover:secondary">
              <li>
                <Link
          ...
          <div className="mt-2 mb-2 leading-relaxed ">
            Funds Management & SmartFX.
          </div>
        </div>

        <div className="m-4 border-t border-accent text-center"></div>

        <div className="text-center p-8">
          <p className="leading-normal">
            Sunset Ventures Inc. is an AI investment management company focused
            on
            <ul className="pt-4">
              <li>Forex & Currency ETF.</li>
              <li>Crypto ETF.</li>
              <li>Quant Algorithm Development.</li>
              <li>Whitelabel Fintech Platforms.</li>
  ...
  return (
    ...
    >
      <defs id="SvgjsDefs1384">
        <linearGradient id="SvgjsLinearGradient1393">
          <stop id="SvgjsStop1394" stop-color="#8f5e25" offset="0" />
          <stop id="SvgjsStop1395" stop-color="#fbf4a1" offset="0.5" />
          <stop id="SvgjsStop1396" stop-color="#8f5e25" offset="1" />
        </linearGradient>
        <linearGradient id="SvgjsLinearGradient1397">
          <stop id="SvgjsStop1398" stop-color="#8f5e25" offset="0" />
          <stop id="SvgjsStop1399" stop-color="#fbf4a1" offset="0.5" />
          <stop id="SvgjsStop1400" stop-color="#8f5e25" offset="1" />
        </linearGradient>
        <linearGradient id="SvgjsLinearGradient1401">
          <stop id="SvgjsStop1402" stop-color="#8f5e25" offset="0" />
          <stop id="SvgjsStop1403" stop-color="#fbf4a1" offset="0.5" />
          <stop id="SvgjsStop1404" stop-color="#8f5e25" offset="1" />
        </linearGradient>
        <linearGradient id="SvgjsLinearGradient1405">
          <stop id="SvgjsStop1406" stop-color="#8f5e25" offset="0" />
          <stop id="SvgjsStop1407" stop-color="#fbf4a1" offset="0.5" />
          <stop id="SvgjsStop1408" stop-color="#8f5e25" offset="1" />
        </linearGradient>
        <linearGradient id="SvgjsLinearGradient1393">
          <stop id="SvgjsStop1394" stop-color="#8f5e25" offset="0" />
          <stop id="SvgjsStop1395" stop-color="#fbf4a1" offset="0.5" />
      ...
      <g
        ...
        fill='url("#SvgjsLinearGradient1393")'
      >
        <path
          xmlns="http://www.w3.org/2000/svg"
      ...
      <g
        ...
        fill='url("#SvgjsLinearGradient1397")'
      >
        <path
          xmlns="http://www.w3.org/2000/svg"
      ...
      <g
        ...
        fill='url("#SvgjsLinearGradient1401")'
      >
        <path
      ...
      <g
        ...
        fill='url("#SvgjsLinearGradient1405")'
      >
        <path
