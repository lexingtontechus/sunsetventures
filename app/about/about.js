  ...
  return (
    <main>
      ...
      <section className="container min-h-screen mx-auto mb-8">
        ...
        <div className="m-8 border-t border-accent text-center"></div>
        ...
        <div className="max-w-xl mx-auto text-center">
          ...
          <p className="text-lg leading-relaxed">Our services span across,</p>
  ...
  return (
    ...
    >
      ...
      <g
        ...
        fill='url("#SvgjsLinearGradient1122")'
      >
        <path
          xmlns="http://www.w3.org/2000/svg"
