        ...
        <div className="mx-auto px-8">
          <div className="flex flex-wrap items-center">
            <div className="mx-auto w-full px-4">
              ...
              >
                <div className="collapse-title">GENERAL NOTICE</div>
                <div className="collapse-content text-xs">
                  <p>
                    ...
                    information, please contact us at sunsetventures@skiff.com.
                    This privacy notice describes how we might use your
                    information if you visit our website:{" "}
                    <span>
                      <Link href="https://sunsetventures.nft">
              ...
              >
                ...
                <div className="collapse-content text-xs">
                  ...
                  <p>
                    ...
                    <span>
                      <Link href="https://4mobeers.nft/support">Support</Link>
                    </span>
                  </p>
                  <p>
